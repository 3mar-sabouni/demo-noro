...
class WATemplate(models.Model):
    ...
    def init(self):
        video_path = tools.misc.file_path('omni_channel_communication_odoo/static/tus_meta_whatsapp_base/static/src/video/wa-demo-video.mp4')
        ...
        pdf_path = tools.misc.file_path('omni_channel_communication_odoo/static/tus_meta_whatsapp_base/static/src/pdf/TestPDFfile.pdf')
        ...
        pdf_path = tools.misc.file_path('omni_channel_communication_odoo/static/tus_meta_wa_discuss/static/src/image/whatsapp_default_set.png')
    ...
    def _get_send_button_params(self, component, object_data, params):
        ...
        if wa_buttons:
            for button, variable in zip(wa_buttons, component.variables_ids):
                parameters = []
                button_dict = {
                    'type': "button",
